...
- R2 Material Runs: `BIP-FR-004-MR-20260908T021905Z` 1개, `INCONCLUSIVE`, 재사용 금지
- R2 readiness responsibility: foreground primary-process invocation과 clean runtime baseline을 사용해 새 Run ID를 등록할지 Control Plane이 판정
