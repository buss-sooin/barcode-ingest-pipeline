...
| BIP-FR-005 — Redis Streams Unavailability | Active traffic 중 Redis handoff failure, source retry, DLT와 bounded disposition 검증 예정 | Historical Run 2건 `INCONCLUSIVE` / Current executable Run 없음 | [Reproduction Record](./failure-reproduction/BIP-FR-005-redis-streams-unavailability/REPRODUCTION-RECORD.md) |
