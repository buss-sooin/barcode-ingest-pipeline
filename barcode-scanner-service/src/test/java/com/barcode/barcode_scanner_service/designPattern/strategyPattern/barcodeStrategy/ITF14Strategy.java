package com.barcode.barcode_scanner_service.designPattern.strategyPattern.barcodeStrategy;

import java.util.Random;

import com.barcode.barcode_scanner_service.designPattern.strategyPattern.checkDigitStrategy.ICheckDigitStrategy;
 ...
 */
public class ITF14Strategy implements IBarcodeStrategy {

    private final ICheckDigitStrategy checkDigitStrategy;
    private static final Random RANDOM = new Random();

    public ITF14Strategy(ICheckDigitStrategy checkDigitStrategy) {
