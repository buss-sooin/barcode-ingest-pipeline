...
5. [운영 장애 검증](#운영-장애-검증) — 실제 구성 요소 장애, 복구, 종단 간 수렴
...
성능과 장애 전파 비교뿐 아니라 실제 구성 요소 장애를 제한된 범위에서 재현하여 장애 영향, 복구, 백로그 소진과 최종 데이터 수렴까지 운영 관점에서 검증했습니다.
...
이 두 비교 검증과 별도로 실제 구성 요소 장애를 재현하고 복구 완료까지 확인하는 [운영 장애 검증](docs/operational-validation/README.md)을 수행했습니다.
